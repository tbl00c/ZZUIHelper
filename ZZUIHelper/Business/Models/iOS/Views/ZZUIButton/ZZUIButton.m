...
- (NSMutableArray *)properties
{
    if (!_properties) {
        ...
        ZZProperty *titleColor = [[ZZProperty alloc] initWithPropertyName:@"titleColor" selectionData:[ZZControlHelper sharedInstance].colors defaultSelectIndex:2 editable:YES];
