...
- (NSMutableArray *)properties
{
    if (!_properties) {
        ...
        ZZProperty *color = [[ZZProperty alloc] initWithPropertyName:@"backgroundColor" selectionData:[ZZControlHelper sharedInstance].colors defaultSelectIndex:0 editable:YES];
